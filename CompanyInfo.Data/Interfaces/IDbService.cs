...
namespace CompanyInfo.Data.Interfaces
{
    public interface IDbService
    {
        ...
        Task<List<FullEmployee>> GetEmployee();
        ...
        Task<List<TDto>> ConnectionGetAsync<TReferenceEntity, TDto>() where TReferenceEntity : class, IReferenceEntity where TDto : class;
