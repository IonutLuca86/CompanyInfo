...
namespace CompanyInfo.Data.Migrations
{
    ...
    [Migration("20221219192806_FirstCreateAndSeed")]
    partial class FirstCreateAndSeed
    {
            ...
            modelBuilder.Entity("CompanyInfo.Data.Entities.Departament", b =>
                {
                    ...
                    b.HasOne("CompanyInfo.Data.Entities.DepartamentsName", "DepartamentName")
                        .WithMany()
                        .HasForeignKey("DepartamentNameID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Company");

                    b.Navigation("DepartamentName");
                });
